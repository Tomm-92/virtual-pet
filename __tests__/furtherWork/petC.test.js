...
describe('constructor', () => {
  it('returns an object', () => {
    expect(new Pet1('Alfie')).toBeInstanceOf(Object);
  });
  it('sets the name property of pet', () => {
    const pet = new Pet1('Alfie')
     ...
     describe('isAlive', () => {
      ...
      describe('adoptChild', () => {
        it('passes the child into the parent object ', () => {
            const parent = new Pet1 ('Dave');
            const child = new Pet1('Amelia');
          ...
          it('feeds the child ', () => {
            const parent = new Pet1 ('Mick');
            const child = new Pet1('Sarah');
            parent.adoptChild(child);
